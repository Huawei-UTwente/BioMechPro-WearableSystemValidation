function [C3Ddata] = getOSIDinM(C3Ddata,subjosidsto,varargin)
%% getOSIDinM
% 
...
% msiz = size(C3Ddata.Resample.Marker,1);
% 
...
C3Ddata.Resample.Sych.IDTrqData = trqData;
C3Ddata.Resample.Sych.IDTrqDataLabel = headercell;
