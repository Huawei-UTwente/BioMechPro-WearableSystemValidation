function [Datastr] = S12_Sychronize(Datastr, MotionSychOpt, ForceSychOpt,...
                            MotionSychDelay, ForceSychDelay, EMGSychDelay)
% gBMPDynUI MotionSychOpt=1; ForceSychOpt=1; MotionSychDelay=1; ForceSychDelay=1; EMGSychDelay=1;
%
...
if strcmpi(Datastr.Info.Trial, 'static_pose')
    ...
    if strcmp(MotionSychOpt, 'True')
       ...
       if isfield(Datastr.Resample.Sych, 'IKAngData') && isfield(Datastr.Resample, 'IMU')
        ...
        motion_SychTime = MotionSychDelay;
